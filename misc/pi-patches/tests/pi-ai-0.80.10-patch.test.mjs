...
const PATCH = resolve(HERE, "../pi-ai-0.80.10-openai-responses-apply-patch-custom-tool.patch");
const CODEX_PATCH = resolve(HERE, "../pi-ai-0.80.10-codex-custom-tool-continuation.patch");
const TARGET_RELATIVE = "dist/api/openai-responses-shared.js";
const CODEX_TARGET_RELATIVE = "dist/api/openai-codex-responses.js";
const BEFORE_SHA256 = "e2b24951ab498820c6f873a2a2e48ba342ecc5b282e9cbfb9a201ea1873f44b7";
const AFTER_SHA256 = "7c3a8aada6d8fb307f158c78030ae950f72a89d4fd645ad126c53e8007f02cf5";
const CODEX_BEFORE_SHA256 = "7d0cafd990d6df68bb5aa36dc837f9b71f31504a09905602a7cce8e37b8a3834";
const CODEX_AFTER_SHA256 = "918f90ae1b20def8c5ff737442a69b4c56c9ae08f067ed4a0f530109df6b1273";
...
test("installer refuses version and content mismatches without modifying the target", async (t) => {
    ...
    assert.match(versionResult.stderr, /Expected @earendil-works\/pi-coding-agent 0\.80\.10/);
    ...
    assert.match(piAiVersionResult.stderr, /Expected @earendil-works\/pi-ai 0\.80\.10/);
