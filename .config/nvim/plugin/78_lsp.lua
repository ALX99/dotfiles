...
vim.lsp.handlers["window/showMessage"] = function(_, result, ctx)
  ...
  local level = ({ [1] = vim.log.levels.ERROR, [2] = vim.log.levels.WARN, [3] = vim.log.levels.INFO, [4] = vim.log.levels.DEBUG, [5] = vim.log.levels.DEBUG })[result.type] or vim.log.levels.INFO
